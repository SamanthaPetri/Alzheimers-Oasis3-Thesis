...
**Repository structure**: `Data Processing/` (extraction, augmentation, ROI statistics) · `Models/Mamba/` (Mamba v1–v6 model iterations). See per-folder READMEs for detail)
